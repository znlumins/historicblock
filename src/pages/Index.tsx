  ...
  return (
    <div className="min-h-screen flex flex-col bg-white border-2 border-[#ced4da] rounded-lg">
      ...
      <section className="w-full h-[578px] bg-gradient-to-r from-historic-cream-light to-historic-cream relative overflow-hidden">
        ...
        {/* Main Content */}
        <div className="flex flex-col items-center justify-center h-full px-20 relative z-10">
          <div className="text-center max-w-4xl">
            <h1 className="font-georgia text-[42px] leading-tight mb-3">
              <span className="text-historic-brown">Selamat Datang di </span>
              <span className="text-historic-brown-dark">Kuis Sejarah</span>
            </h1>

            <p className="font-merriweather text-[16.766px] leading-[22.355px] text-[#2c1810] mb-12 max-w-3xl mx-auto">
      ...
      <section className="w-full bg-white py-20 px-20">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-quicksand text-4xl text-gray-800 mb-2">
              Papan Peringkat
            </h2>
